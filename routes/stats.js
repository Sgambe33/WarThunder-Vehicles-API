        ...
        router.get('', async (req, res) => {
            try {
                ...
                const vehicleTypeGroup = vehicleStatsQuery.reduce((accumulator, item) => {
                    ...
                    accumulator[item.country].vehicle_types[item.vehicle_type] = parseInt(item.dataValues.total_vehicles);
                    accumulator[item.country].total_vehicles += parseInt(item.dataValues.total_vehicles);
                    return accumulator;
                }, {});
